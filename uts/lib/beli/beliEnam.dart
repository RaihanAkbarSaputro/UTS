          ...
          body: Form(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Image.network('https://images.tokopedia.net/img/cache/900/hDjmkQ/2022/1/22/33108f0b-644d-4fe8-8963-6c7e7cdce5de.jpg', width: 150, height: 150,),
                  const SizedBox(height: 10), 
                  const Text('Mercusys MW302R Multi-Mode Wireless N Router 300Mbps', textAlign: TextAlign.center,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),

                  const SizedBox(height: 10), 
                    const Text('Rp133.999',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold, color: Colors.red)),
